        					...
        					<div class="box-body">
        						<div class="row">
            						...
            						<div class="row">
             							<div class="col-xs-12 col-md-3 col-lg-3">
             								<br>
        									<button  id="bt_Cancelar" name="Editar" class="btn btn-danger" onclick="Cancelar()"> <i class="glyphicon glyphicon-remove"></i>CANCELAR</button>
            							</div>
            						</div>
            					</div>
            				</div>
    ...
    <script src="view/Administracion/js/TareaRespaldos.js?1.4"></script>
  </body>
</html>   
